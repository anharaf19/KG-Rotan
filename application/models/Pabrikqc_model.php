...
class Pabrikqc_model extends CI_Model
{
    ...
    function lihatspk2($pabrik)
    {
        return $this->db->query("select spk.no_spk as no_spk, 
                                ...
                                join detail_po_pabrik on po_pabrik.id=detail_po_pabrik.id_po_pabrik   
